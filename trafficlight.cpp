...
void sortarray(car [], car [], int , int & , int , char );
int main() {
    ...
    sortarray(orderOfCar, inputcar, sizeOfList, maxnum, loopNum, direction);
...
void sortarray(car orderOfCar[], car inputcar[], int sizeOfList, int & maxnum, int loopNum, char direction)
    {
